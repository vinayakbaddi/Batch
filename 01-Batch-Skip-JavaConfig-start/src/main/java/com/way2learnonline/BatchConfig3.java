...
public class BatchConfig3 {
	...
	public Step step(ItemReader<Product> productReader,ItemWriter<Product> productWriter)
	{
		return stepBuilderFactory.get("readerWriter")
				...
				.skipLimit(4)  //TODO 1 : decrease skip limit , make it  less than 3 i.e. incorrect records but due to skippolicy it will work
				//.skipPolicy(alwaysSkipItemSkipPolicy()) //TODO 2: Configure skipPolicy
				.build();
	}
	
	@Bean
	public AlwaysSkipItemSkipPolicy alwaysSkipItemSkipPolicy()
	{
